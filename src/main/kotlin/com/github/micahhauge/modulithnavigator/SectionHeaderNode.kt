...
class SectionHeaderNode(project: Project, label: String, private val nodeWeight: Int, private val icon: Icon? = null) :
    ...
    override fun update(presentation: PresentationData) {
        if (icon != null && ModulithNavigatorSettings.getInstance().state.showSectionIcons) {
